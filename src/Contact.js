                    ...
                    <div className="contact-details">
                        <div className="contact-item">
                            <a href="mailto:melbinproy76@gmail.com">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-envelope-open-fill" viewBox="0 0 16 16">
                        ...
                        <div className="contact-item">
                            <a href="https://www.linkedin.com/in/melbin-p-roy" rel="noreferrer">
